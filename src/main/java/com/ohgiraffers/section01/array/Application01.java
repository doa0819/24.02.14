...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   배얄은 heap 영역에 new 연산자를 이용하여 할당한다.  (new -> 할당 연산자 / 공간을 할당 받는다.)
        *   */
        ...
        *   이런 식으로 선언을 할 수 있다. */
        ...
        /* 필기. 선언은 stack 에 배열의 주소를 보관 할 수 있는 공간을 만드는 것이다. */
        /*변수는 -> 값을 보관 배열-> 주소를 보관*/
...
//        age[2] = 30;
//        age[3] = 40;
//        age[4] = 50;   //1가지의 변수로 5가지의 값을 가지고 있다.

        System.out.println("age[0] : " + age[0]); // 값을 넣지 않았지만 출력이 되는건 공간이 만들어 지면 무조건 기본값이 존재 해야 한다.
        ...
        *   갯수 만큼 자동으로 크기가 설정된다. */
        ...
        int[] iarr4 = {10, 20, 30, 40, 50};  // new 를 안써도 된다 {} 쓸떄에는 (써도 상관은 옶다)
        int[] iarr5 = new int[] {10, 20, 30, 40, 50, 60};

        System.out.println("iarr4 의 길이 : " + iarr4.length);
        System.out.println("iarr4 의 길이 : " + iarr5.length);
