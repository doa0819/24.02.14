...
public class Application04 {
    ...
    public static void main(String[] args) {
        ...
        *   깊은 복사는 원본과 복사본 둘 중 한가지 값을 변경해도 다른 하나에 영향을 주지 않는다. */
        ...
        int[] arr1={1, 2, 3, 4, 5};
        int[] arr2 = arr1.clone();     //clone 은 간단하지만 길이를 만들 수 없다(length)
        ...
        *          대신, 변경하는 것이 아니고 사용하는 것이 목적이라면 조금 더 편하게 사용 할 수 있다. */


        for (int i : arr2){          // arr2 가 arr1 에 들어간다 ex) arr2 - 1 이 arr1 에 1 를 넣는다
            System.out.print(i + " ");
